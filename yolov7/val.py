...
def run(data,
    ...
    print(pf % ('all', seen, nt.sum(), mp, mr, map50, map), file = txt)
...
if __name__ == '__main__':
    run(data="coco.yaml", weights="yolov7.pt", batch_size=32,  imgsz=640,  conf_thres=0.001, iou_thres=0.6)
    # parser = argparse.ArgumentParser(prog='test.py')
    # parser.add_argument('--weights', nargs='+', type=str, default='yolov7.pt', help='model.pt path(s)')
    # parser.add_argument('--data', type=str, default='coco.yaml', help='*.data path')
